    ...
    public class Vendedor : Usuario
    {
        ...
        public static int Agregar(string nombre, float precio, int stock, string tipo)
        {
            ...
            if (nombre != "" && precio > 0 && stock > 0)
            {
                ...
                if (valido && rta != 2)
                {
                    ListaProductos.Add(new Producto(producto.Corte, producto.Precio, producto.Stock, producto.Tipo));
                    rta = 0;
                }
            }
                ...
                if (producto.Stock > 0) // pregunta si el produto tiene stock
                {
                    ...
                    if (MontoCliene > 0 && producto.Precio <= MontoCliene)
                    {
                        ...
                        if (!_productoCargado && !_stockMax)
                        {
                            ...
                            aux = producto;
                            ListCarrito.Add(new Producto(aux.Corte, aux.Precio, 1 , aux.Tipo));
                            retorno = 0;
                        }
