...
namespace Login
{
    public partial class Frm_HeladeraCliente : Form
    {
        //// Objeto
        ...
        //        if (clienteMain.Saldo > 0 && producto.Precio_Producto <= clienteMain.Saldo)
        //        {
        ...
        //    {
        //        Frm_Carrito frmCarrito = new Frm_Carrito(listaCarrito, clienteMain);
