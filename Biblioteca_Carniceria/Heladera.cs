...
namespace Biblioteca_Carniceria
{
    public class Heladera : Producto
    {
        ...
        public Heladera()
        {
            ...
            ListaProductos.Add(new Producto("Bife De Chorizo", eCortes.BifeDeChorizo, 10, "Corte vacuno"));
            ...
            ListaProductos.Add(new Producto("Lomo Vetado", eCortes.LomoVetado, 10, "Corte ternero"));
            ListaProductos.Add(new Producto("Colita De Cuadril", eCortes.ColitaDeCuadril, 10, "Corte ternero"));
            ListaProductos.Add(new Producto("Tapa De Asado", eCortes.TapaDeAsado, 10, "Corte vacuno"));
            ...
            ListaProductos.Add(new Producto("Cadera De Ternera", eCortes.CaderaDeTernera, 10, "Corte ternero"));
            ListaProductos.Add(new Producto("Callos", eCortes.Callos, 10, "Corte ternero"));
            ListaProductos.Add(new Producto("Chuleta De Ternera Rosada", eCortes.ChuletaDeTerneraRosada, 10, "Corte ternero"));
            ListaProductos.Add(new Producto("Chuleta De Vaca", eCortes.ChuletónDeVaca, 10, "Corte vacuno"));
            ListaProductos.Add(new Producto("Contra", eCortes.Contra, 10, "Corte ternero"));
            ListaProductos.Add(new Producto("Entrecot De Ternera Rosada", eCortes.EntrecotDeTerneraRosada, 10, "Corte ternero"));
            ListaProductos.Add(new Producto("Etrecot De Ternera Blanca", eCortes.EtrecotDeTerneraBlanca, 10, "Corte ternero"));
            ListaProductos.Add(new Producto("Lengua", eCortes.Lengua, 10, "Corte ternero"));
            ListaProductos.Add(new Producto("Morcillo De TerneraBlanca", eCortes.MorcilloDeTerneraBlanca, 10, "Corte ternero"));
            ListaProductos.Add(new Producto("Osobuco", eCortes.Osobuco, 10, "Corte ternero"));
            ListaProductos.Add(new Producto("Perdiz De Ternera", eCortes.PerdizDeTernera, 10, "Corte ternero"));
